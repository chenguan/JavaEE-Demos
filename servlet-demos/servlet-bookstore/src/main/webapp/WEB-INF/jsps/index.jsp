		...
		<tr style="background:#ffddaa">
			<td colspan="2" height="80" style="padding-right:10px">
				...
				<c:choose>
					...
					<a target="dataFrame" href="<c:url value='/src/main/webapp/jsps/user/login.jsp'/>">登录</a>
					|
					<a target="dataFrame" href="<c:url value='/src/main/webapp/jsps/user/reg.jsp'/>">注册</a>
					</c:when>
					<c:otherwise>
						...
						|
						<a target="dataFrame" href="<c:url value='/src/main/webapp/jsps/buy/car.jsp'/>">购物车</a>
						|
