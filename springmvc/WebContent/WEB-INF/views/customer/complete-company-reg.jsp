		...
		<div id="content">
			...
			<div id="complete-reg">
				<form method="post" enctype="multipart/form-data" action="/springmvc/customer/companyUserNextStep">
					<div id="left-reg">
						<ul>
							<li><span class="label">企业类型:</span> <select name="companyType"
								class="reg-input">
									<option value=""></option>
							...
							<li><span class="label">注册资本:</span> <input type="text"
								name="registerCapital" class="reg-input"></li>
							<li><span class="label">营业执照注册号:</span> <input type="text"
								name="businessLicence" class="reg-input"></li>
							<li><span class="label">法定代表人:</span> <input type="text"
								name="legalRepresentative" class="reg-input"></li>
							<li><span class="label">成立时间:</span> <input type="text"
								name="createTime" class="reg-input" id="date"></li>
							<li><span class="label">注册地址:</span> <input type="text"
								name="registerAddress" class="reg-input"></li>
							<li><span class="label">总部地址:</span> <input type="text"
								name="headquartersAddress" class="reg-input"></li>
							<li><span class="label">咨询电话:</span> <input type="text"
								name="first" id="first"> <span>-</span> <input type="text"
								name="second" id="second"></li>
							<li><span class="label">所属行业:</span> <select name="workField"
								class="reg-input">
									<option value=""></option>
							...
							<li><span class="label">主要业务:</span> <input type="text"
								name="mainField" class="reg-input"></li>
							<li><span class="label">盈利模式:</span> <select name="earnPattern"
								class="reg-input">
									<option value=""></option>
							...
							<li><span class="label"></span> <input type="submit"
								id="btn" value="下一步" /></li>
						</ul>
					</div>
					<div id="right-reg">
