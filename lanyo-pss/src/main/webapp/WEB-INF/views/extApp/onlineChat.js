...
OnlineUserWindow=Ext.extend(Ext.Window,{
	...
	initComponent : function(){
		 this.tbar=[
		 		{text:"刷新",cls:"x-btn-text-icon",icon:"images/core/refresh.gif",handler:this.refreshUser,scope:this},
		 		"-",
	...
	this.add({title:"在线用户",iconCls:"confirm-icon",
			//hidden:true,
			layout:"fit",
			collapsed:true,	
			border : false,
...
OnlineMessageManager.me={id:Global.User.id,name:Global.User.name};
