...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="/stylesheets/logined-invest-index.css">
...
<body>
    ...
    <div id="main">
        <div id="content">
                ...
                <div id="invest-list">
                    <div id="left-banner">
                        ...
                        <div class="banner" id="site-banner-l">
                            <ul>
                                <li style="background-image:url(/images/touzizhe1.png)">
                                </li>
                                <li style="background-image:url(/images/touzizhe2.png)">
                                </li>
                            </ul>
                        </div>
                        <div class="invest-more">
                            <span><a href="/springmvc/investor/investModel" title="">查看更多行业>></a></span>
                        </div>
                    </div>
                    <div id="right-banner">
                        <p>行业二</p>
                        <div class="banner" id="site-banner-r">
                            <ul>
                                <li style="background-image:url(/images/touzizhe3.png)">
                                </li>
                                <li style="background-image:url(/images/touzizhe4.png)">
                                </li>
                            </ul>
                        </div>
                        <div class="invest-more">
            ...
            <div id="news">
                <p id="zixun"><a href="/springmvc/investor/consulting">资讯</a></p>
                <div id="news-area">
                    <ul>
                        <li>
                            <div class="title-nav">
                                <span>政策资讯</span>
                                <span class="more">
                                    <a href="/springmvc/investor/infoPolicy" title="">更多</a>
                                </span>
                            </div>
                            <div id="policy-item">
                        ...
                        <li>
                            <div class="title-nav">
                                <span>市场资讯</span>
                                <span class="more">
                                    <a href="/springmvc/investor/infoMarket" title="">更多</a>
                                </span>
                            </div>
                            <div id="market-item">
